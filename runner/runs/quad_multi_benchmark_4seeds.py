...
_experiment = Experiment(
    'quads_sanity_check_4seeds_72_4',
...
RUN_DESCRIPTION = RunDescription('quads_multi_benchmark_4seeds_72_4', experiments=[_experiment])
...
# By using sample-factory: v102, training for 280 M framesteps, average the avg_true_reward of 4 seeds,
# Mean: -220. Standard deviation: 12
# By using sample-factory: v102, training for 500 M framesteps, average the avg_true_reward of 4 seeds,
